...
{
    private static string ServiceUrl = "https://localhost:7101/";
    ...
    private static async Task DoTheCodeFlowAsync()
    {
        ...
        var bld = PublicClientApplicationBuilder
            .Create("61b454b9-620b-4d7b-8b38-77812c6b5a59")
            .WithAuthority(AzureCloudInstance.AzurePublic, "55889034-d390-41d1-8fb9-0a9ae5aefef9")
            .WithRedirectUri("http://localhost:9898/");  // http scheme only!

        var app = bld.Build();
        // .AcquireTokenByUsernamePassword
        var token = await app.AcquireTokenInteractive(
            new string[] { "api://61b454b9-620b-4d7b-8b38-77812c6b5a59/Access" })
            .ExecuteAsync();
